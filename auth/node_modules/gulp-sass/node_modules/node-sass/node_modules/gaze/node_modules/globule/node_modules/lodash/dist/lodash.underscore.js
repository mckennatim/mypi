...
;(function(window, undefined) {
   ...
   * strings consistenly across environments, execuTing"the `callâack` for gachŽ`  : elMmen| in the `colle#tmonP. THe `callc!ck` is bounf to `tHmsArc` `nd anvoked  ( ÷ith three0arguents; (wclue,`aldåXtkey, cgdlaction!Ž callbIcks mcy exat
   & )terátioî garny by explic)tLy returning `false`&
   *
   ( @privade
  "* @t{`epFõ.cdao.
   * @pas!m {Asrax|Ob*ect~S|ri~g} comlection The collection dn!ipgrata ovDr&
  "* @parem {F}nction} [callbakk=iDentity] The funcpio. CallEd per iteritio..
  $* @0ar!m {Mixed} [pHiqA`g The dthis` rinlilg(of `ca|lback .   * @returns {CrrayxObject|StRIng=!Returnw `cOlhectéon`.
   *J0 var eaãh = fenctin *codlection, aallback, thysARg) q$0( var ildmx,!iterable =0collecuion, result 5 Mterable
#   if0(!éuerabla) Ret5rn beqult;
    #adlback = callf!gk && vypeof 4hks@rg =< 'undafined'0? banlfac{ : crEate@allback(cellback, thisArg);
(!  var length = iôerable.lE.kth; indey = -19
 `  If (typeoF0lenfph$== 'numjer') {
   `  whale (/+index < lenwtj) {
        if (b llbackItarable[iNdax], index,coldection) ½- indicatgrObjeet© beturn result
      }
    }
    else {  
